        ...
        <div class="row">
            <div class="col-6">
                ...
                <input type="text" name="name" class="form-control" placeholder="Enter name"
                    value="{{ old('name') ?? $product->name }}" minlength="3" maxlength="60" required>
                @if ($errors->has('name'))
            ...
            <div class="col-6">
                ...
                <select name="category" class="form-control" required>
                    ...
                    <option value="category 1" {{ old('category', $product->category) === 'category 1' ? 'selected' : '' }}>
                        Category 1</option>
                    <option value="category 2" {{ old('category', $product->category) === 'category 2' ? 'selected' : '' }}>
                        Category 2</option>
                    <option value="category 3" {{ old('category', $product->category) === 'category 3' ? 'selected' : '' }}>
                        Category 3</option>
                    <option value="category 4" {{ old('category', $product->category) === 'category 4' ? 'selected' : '' }}>
                        Category 4</option>
                </select>
            ...
            <div class="col-12 mt-2">
                ...
                <textarea name="description" class="form-control" rows="10" minlength="3" maxlength="20000" required>{{ old('description') ?? $product->description }}</textarea>
